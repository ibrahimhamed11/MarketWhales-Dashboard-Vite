/**
 * Consolidated Styles for User Pages
 * Contains all Material-UI sx prop styles for UserCoursesPage and CoursePage
 */
...
export const loadingCircularProgressStyles = {
  mb: 2
};
...
export const videosLoadingBoxStyles = {
  display: 'flex',
  justifyContent: 'center',
  alignItems: 'center',
  py: 6
...
export const videosLoadingProgressStyles = {
  mr: 2
};
...
// ============================================================================
// COURSE GRID STYLES (UserCoursesPage)
// ============================================================================
...
export const courseActionButtonMobileStyles = {
  mr: { xs: 0, sm: 1 },
  mb: { xs: 1, sm: 0 }
};
...
export const errorAlertButtonStyles = {
  textTransform: 'none'
};

export const loadingTypographyStyles = {
  fontFamily: 'inherit'
};
...
// ============================================================================
// STATISTICS/ICON BOX STYLES
// ============================================================================

export const iconBoxSmallStyles = {
  w: "56px",
  h: "56px"
};
...
// ============================================================================
// TYPOGRAPHY WITH FONT FAMILY STYLES
// ============================================================================

export const createTypographyWithFontStyles = (baseStyles, fontFamily) => ({
  ...baseStyles,
  fontFamily
});

// ============================================================================
// VIDEO GRID STYLES (CoursePage)
// ============================================================================

export const videosGridContainerStyles = {
  container: true,
  spacing: 3,
};

export const getVideoGridItemStyles = (viewMode) => ({
  xs: 12,
